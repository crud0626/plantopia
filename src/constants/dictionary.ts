...
import SUN_ON_ICON from '@/assets/icons/dict_sun_on.png';
import SUN_OFF_ICON from '@/assets/icons/dict_sun_off.png';
import WATER_ON_ICON from '@/assets/icons/water_on_icon.png';
import WATER_OFF_ICON from '@/assets/icons/dict_water_off.png';
